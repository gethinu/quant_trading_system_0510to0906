...
| **Phase 2** | [基礎データ読込](./2.%20基礎データ読込フェーズ.md)                 | キャッシュからのデータ取得 |
| **Phase 3** | [フィルター実行](./3.%20フィルター実行フェーズ.md)                 | Two-Phase 1 段階目         |
| **Phase 4** | [セットアップ評価](./4.%20セットアップ評価フェーズ.md)             | Two-Phase 2 段階目         |
| **Phase 5** | [シグナル抽出](./5.%20シグナル抽出フェーズ（トレード候補選定）.md) | ランキング・候補選定       |
| **Phase 6** | [配分・最終リスト生成](./6.%20配分・最終リスト生成フェーズ.md)     | 資金配分・最終決定         |
| **Phase 7** | [保存・通知](./7.%20保存・通知フェーズ.md)                         | CSV 出力・Slack 通知       |
