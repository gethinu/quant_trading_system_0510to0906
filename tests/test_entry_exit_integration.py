        ...
        df = pd.DataFrame(
            {
                ...
                # entry bar (idx 1) must trade down through the 0.93 limit
                # (prev_close 101 -> 93.93) or the limit never fills
        ...
        df_common = pd.DataFrame(
            {
                ...
                # idx 1 dips to 93 so System3 の 93.93 指値が実際に約定する
                "Low": [99, 93, 100, 98, 97],
        ...
        df = pd.DataFrame(
            {
                ...
                # idx 1 dips to 96 so System5 の 97.00 指値が実際に約定する
                "Low": [99, 96, 99, 99, 99, 99, 99, 99, 99, 99],
