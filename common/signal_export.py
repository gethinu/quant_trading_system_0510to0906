    ...
    *,
    ...
    payload = {
        ...
        "meta": {
            ...
            # Delivery belongs to this exact run_id.  A nightly re-generation
            # must not inherit the morning run's success badge, but it also
            # must not silently drop the field and look indistinguishable from
            # legacy data.  publish_signals replaces this projection after an
            # actual attempt.
